...
import { z } from "zod";
import { getReportingQueryParams, getReportingResponse } from "../../../api/generated/umbracoEngageManagementApi.zod.js";
import type { getUmbracoEngageManagementAPI } from "../../../api/generated/umbracoEngageManagementApi.js";

type ApiClient = ReturnType<typeof getUmbracoEngageManagementAPI>;

const inputSchema = getReportingQueryParams;
const outputSchema = z.object({ items: getReportingResponse });

const tool: ToolDefinition<typeof inputSchema.shape, typeof outputSchema> = {
  name: "get-reporting",
  description:
    "List the Umbraco Engage Reporting resource. Calls GET /umbraco/engage/management/api/v1/reporting.",
