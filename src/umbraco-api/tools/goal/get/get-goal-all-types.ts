...
import { z } from "zod";
import { getGoalAllTypesResponse } from "../../../api/generated/umbracoEngageManagementApi.zod.js";
import type { getUmbracoEngageManagementAPI } from "../../../api/generated/umbracoEngageManagementApi.js";

type ApiClient = ReturnType<typeof getUmbracoEngageManagementAPI>;

const inputSchema = z.object({});
const outputSchema = z.object({ items: getGoalAllTypesResponse });
...
const tool: ToolDefinition<typeof inputSchema.shape, typeof outputSchema> = {
  ...
  handler: async () => {
    const result = await executeGetApiCall<ReturnType<ApiClient["getGoalAllTypes"]>, ApiClient>(
      (client) => client.getGoalAllTypes(CAPTURE_RAW_HTTP_RESPONSE),
    );
